            ...
            <svg className="overflow-visible p-2" {...gauge.getSVGProps()}>
                <g id="arcs" filter="url(#filter0_d_510_1894)" style={{
                    ...
                    <path
                        ...
                        fill="url(#paint0_linear_528_2335)"/>
                    <path
                        ...
                        fill="url(#paint1_linear_528_2335)"/>
                    <defs>
                        <linearGradient id="paint0_linear_528_2335" x1="18.5" y1="108" x2="78.5" y2="11" gradientUnits="userSpaceOnUse">
                            <stop stopColor="#36E166"/>
                            <stop offset="0.342399" stopColor="#E8EC20"/>
                            <stop offset="1" stopColor="#EC6920"/>
                        </linearGradient>
                        <linearGradient id="paint1_linear_528_2335" x1="82.5217" y1="0.565242" x2="118.5" y2="38.5" gradientUnits="userSpaceOnUse">
                            <stop offset="0.453125" stopColor="#EC6920"/>
                            <stop offset="1" stopColor="#8C0011"/>
                        </linearGradient>
                    </defs>
                </g>
                <g id="needle">
